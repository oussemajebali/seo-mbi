          ...
          <div class="box box-primary">
            ...
            <?php if(isset($msg)) echo $msg; ?>
                <div class="row" style="padding-left: 5px;">
                    ...
                    <div class="form-group">
                        <label for="site">Tools Page - Top Ad</label>
                        <textarea placeholder="Enter your Javascript / HTML Code" name="smallSEOAd" class="form-control"><?php echo $smallSEOAd; ?></textarea>
                        <small>Shortcode: {{smallSEOAd}}</small>
                    </div>

                    <div class="form-group">
                        <label for="site">Tools Page - Middle Ad</label>
                        <textarea placeholder="Enter your Javascript / HTML Code" name="smallSEOAd1" class="form-control"><?php echo $smallSEOAd1; ?></textarea>
                        <small>Shortcode: {{smallSEOAd1}}</small>
                    </div>

                    <div class="form-group">
                        <label for="site">Homepage Ad</label>
                        <textarea placeholder="Enter your Javascript / HTML Code" name="smallSEOAd2" class="form-control"><?php echo $smallSEOAd2; ?></textarea>
                        <small>Shortcode: {{smallSEOAd2}}</small>
                    </div>
